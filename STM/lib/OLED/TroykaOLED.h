...
public:
    ...
    void testDrawCenterDot();
    void testFillScreen(uint8_t color = WHITE);
    ...
    void print(int8_t n, int16_t x = OLED_THIS, int16_t y = OLED_THIS, uint8_t base = 10);
    void print(uint8_t n, int16_t x = OLED_THIS, int16_t y = OLED_THIS, uint8_t base = 10);
    void print(int16_t n, int16_t x = OLED_THIS, int16_t y = OLED_THIS, uint8_t base = 10);
    void print(uint16_t n, int16_t x = OLED_THIS, int16_t y = OLED_THIS, uint8_t base = 10);
    void print(int32_t n, int16_t x = OLED_THIS, int16_t y = OLED_THIS, uint8_t base = 10);
    void print(uint32_t n, int16_t x = OLED_THIS, int16_t y = OLED_THIS, uint8_t base = 10);
    ...
    uint8_t getFontWidth() const { return _font.width; }
    uint8_t getFontHeight() const { return _font.height; }
